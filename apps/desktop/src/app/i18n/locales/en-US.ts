export default {
  ...
  skills: {
    ...
    compatibilityPlaceholder: "Compatibility (optional)",
    allowedToolsPlaceholder: "Allowed tools (optional)",
    contentPlaceholder: "Enter Skill instructions",
    resourcesLabel: "Bundled resources:",
  ...
  mcp: {
    title: "MCP servers",
    description:
      "Connect external tools through the MCP adapter. Changes apply to the current session.",
    project: "Project",
    global: "All projects",
    name: "Server name",
    definition: "Server configuration (JSON)",
    definitionHelp:
      "Use command and args for a local server, or url for a remote server. Other adapter options can be added here.",
    ...
    emptyDescription: "Add a server to make its tools available to the agent.",
    add: "Add server",
    edit: "Edit",
    ...
    invalidName:
      "Use letters, numbers, dots, underscores, or hyphens for the server name.",
    invalidDefinition: "Enter a JSON object with a command or URL.",
    duplicateName: "A server with this name already exists in this scope.",
    removeTitle: "Remove MCP server?",
    removeDescription: "Remove {name} from this configuration?",
  },
  project: {
    ...
    transcript: {
      ...
      toolSteps: {
        ...
        mcp: {
          active: "Running {count} MCP operations",
          complete: "Ran {count} MCP operations",
        },
        presentFile: {
      ...
      tools: {
        ...
        mcp: {
          complete: "Ran MCP {operation}",
          error: "MCP {operation} failed",
          running: "Running MCP {operation}",
          operations: {
            call: "tool call",
            search: "tool search",
            connect: "server connection",
            describe: "tool lookup",
            instructions: "instructions lookup",
            action: "action",
            script: "script",
            status: "status check",
          },
