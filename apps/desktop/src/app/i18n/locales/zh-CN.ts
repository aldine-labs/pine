export default {
  ...
  skills: {
    ...
    licenseLabel: "Skill 许可证",
    compatibilityLabel: "Skill 兼容性",
    allowedToolsLabel: "允许的工具",
    namePlaceholder: "skill-name",
    descriptionPlaceholder: "Skill 描述（何时使用）",
    licensePlaceholder: "许可证（可选）",
    compatibilityPlaceholder: "兼容环境（可选）",
    allowedToolsPlaceholder: "允许的工具（可选）",
  ...
  sessions: {
    ...
    createGroupTitle: "新建会话分组",
    createGroupDescription: "将相关会话归入同一个分组。",
    renameGroupAction: "重命名分组",
    renameGroupTitle: "重命名会话分组",
    renameGroupDescription: "为这个会话分组输入一个新名称。",
    deleteGroupAction: "删除分组",
    deleteGroupTitle: "删除会话分组？",
    deleteGroupDescription:
      "分组“{name}”将被删除，其中的会话仍保留在会话列表中。",
    groupNameLabel: "分组名称",
    groupNamePlaceholder: "例如：产品规划",
    emptyGroup: "该分组暂无会话",
    moveToGroupAction: "移动到分组",
  ...
  mcp: {
    title: "MCP 服务器",
    description: "通过 MCP 适配器连接外部工具。改动会应用到当前会话。",
    project: "当前项目",
    global: "所有项目",
    name: "服务器名称",
    definition: "服务器配置（JSON）",
    definitionHelp:
      "本地服务器填写 command 和 args，远程服务器填写 url；也可添加适配器支持的其他选项。",
    configured: "已配置",
    status: {
      connected: "已连接",
      disabled: "已停用",
    ...
    enabled: "启用服务器",
    empty: "尚未配置服务器",
    emptyDescription: "添加服务器，让 Agent 能使用它提供的工具。",
    add: "添加服务器",
    edit: "编辑",
    ...
    invalidDefinition: "请输入包含 command 或 url 的 JSON 对象。",
    duplicateName: "此范围内已存在同名服务器。",
    removeTitle: "删除 MCP 服务器？",
    removeDescription: "从配置中删除 {name}？",
  },
  project: {
    closeProject: "关闭项目",
    preferences: "项目设置",
    ...
    composer: {
      ...
      approval: {
        ...
        agentDecides: "平衡自主性与可控性，选择性询问。",
        autonomousLabel: "自主工作",
        autonomous: "最大化 AI 自主工作能力，无需外部用户操作。",
        yoloLabel: "干就完了",
    ...
    transcript: {
      ...
      toolSteps: {
        ...
        mcp: {
          active: "正在执行 {count} 次 MCP 操作",
          complete: "执行了 {count} 次 MCP 操作",
        },
        presentFile: {
      ...
      tools: {
        ...
        mcp: {
          complete: "已执行 MCP {operation}",
          error: "MCP {operation}失败",
          running: "正在执行 MCP {operation}",
          operations: {
            call: "工具调用",
            search: "工具搜索",
            connect: "服务器连接",
