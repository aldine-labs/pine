...
const HOST = "com.pine.computer_use";
const GROUP_TITLE = "Pine";
const OWNED_STATE_KEY = "ownedState";

/**
 * Per-MCP-client ownership. Pine and extra MCP children share
  ...
  try {
    const res = await send(tabId, "Runtime.evaluate", {
      expression:
        ...
        `  const el = document.getElementById('__pineAgentCursor');` +
...
//
// Toolbar icon = Pine logo (manifest icons/). Tab favicon = the Computer Use
